...
function AddTaskModal({ onClose, onAdd ,openState,close, showAddModal,setShowAddModal}) {
    ...
    return (
        ...
        //     </div>
        // </div>
    <Dialog open={showAddModal} onClose={setShowAddModal} className="relative z-10">
        <DialogBackdrop
            transition
